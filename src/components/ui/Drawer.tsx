...
export function Drawer({ open, title, children, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/50 backdrop-blur-sm" role="dialog" aria-modal="true">
      ...
      <aside className="relative h-[100dvh] w-full overflow-y-auto border-l border-white/10 bg-[#11141d] p-4 pb-8 shadow-2xl animate-fade-in sm:max-w-2xl sm:p-6 lg:max-w-3xl">
